    ...
    <div class="performances">
        ...
        <div class="container">
            ...
            <form class="post-form" method="POST" action="{{ route('performances.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="starttime">Starttijd: <b>*</b></label>
                ...
                <div class="form-group">
                    <label for="endtime">Eindtijd: <b>*</b></label>
                ...
                <div class="form-group">
                    <label for="available_seats">Aantal plekken: <b>*</b></label>
                ...
                <div class="form-group">
                    <label for="location_embed">Google Maps Link:</label>
                ...
                <div class="form-group">
                    <label for="price">Prijs: <b>*</b></label>
