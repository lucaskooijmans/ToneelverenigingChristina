...
<body>
    ...
    <div class="gallery">
        ...
        <form action="{{ route('gallery.update', $photo->id) }}" method="POST" class="post-form">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" name="description" rows="6" required>{{ $photo->description }}</textarea>
            </div>
