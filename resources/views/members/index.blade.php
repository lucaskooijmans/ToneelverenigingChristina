                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('members.destroy', $member->id) }}" method="POST"
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        onclick="return confirm('Weet je zeker dat je dit lid wilt verwijderen?')">Verwijderen</button>
                                </form>
                                @if ($member->isActive)
                                    <form action="{{ route('members.removeIsActive', $member->id) }}" method="POST"
                                        style="display:inline;">
                                        @csrf
                                        @method('PUT')
                                ...
                                @else
                                    <form action="{{ route('members.setIsActive', $member->id) }}" method="POST"
                                        style="display:inline;">
                                        @csrf
                                        @method('PUT')
